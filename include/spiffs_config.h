...
#define _SPIFFS_MEMCPY(__d, __s, __l) do{os_memcpy((__d),(__s),(__l));}while(0)
#define memset os_memset
#define strncpy os_strncpy
#define strcpy os_strcpy
#define strlen os_strlen
#define spiffs_printf os_printf
...
// denk dat dit nodig is voor 4 byte aligned reads :O? werkt dus niet....
